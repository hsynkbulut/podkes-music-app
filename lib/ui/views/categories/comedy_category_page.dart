...
class ComedyCategoryPage extends StatefulWidget {
  const ComedyCategoryPage({Key? key}) : super(key: key);

  @override
  State<ComedyCategoryPage> createState() => _ComedyCategoryPageState();
}

class _ComedyCategoryPageState extends State<ComedyCategoryPage> {
  @override
  Widget build(BuildContext context) {
    ...
    List<Data> lifeCategoryData =
        musics.where((data) => data.category == "Comedy").toList();
